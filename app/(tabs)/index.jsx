...
export default function HomeScreen() {
  ...
  return (
    <View className="flex-1 items-center bg-orange-200">
      <View className="p-4">
      <Text className="text-center text-lime-800 font-bold text-lg">
          Created by Carl Patrick Daguinotas
        </Text>
        <Text className="text-center text-lime-700 font-medium">
          BSIT 3R10 - IT323
        </Text>
        <Text className="text-3xl text-center font-extrabold text-lime-800 mb-4">RECIPE LIST</Text>
      </View>
